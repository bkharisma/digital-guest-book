...
<head>
  ...
  <title>Form Poltekpar Palembang</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href=""><img src="{{ asset('assets/img/logo-nav.png') }}" alt="Logo"></a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
          ...
          <h1>Politeknik Pariwisata Palembang</h1>
          <h2>Berkomitmen menjadi perguruan tinggi bidang kepariwisataan berstandar internasional, untuk mencetak SDM unggul dan berkepribadian Indonesia</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="/bukutamu" class="btn-get-started scrollto">Form Tamu</a>
            <a href="https://www.youtube.com/watch?v=qm5uHc9gyPU&t=8s" class="glightbox btn-watch-video"><i
                class="bi bi-play-circle"></i><span>Profil Poltekpar Palembang</span></a>
          </div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Layanan</h2>
          <p>
            Pelayanan berbasis Form pada Poltekpar Palembang terdapat beberapa layanan.
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="/bukutamu">Digital Guest Book</a></h4>
              <p>
                Layanan form digital untuk pencatatan tamu yang berkunjung ke Politeknik Pariwisata Palembang.
              </p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="">Permohonan Informasi Publik</a></h4>
              <p>Form Permohonan Informasi Publik yang ingin diajukan ke Politeknik Pariwisata Palembang.
              </p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="">Keberatan Informasi Publik</a></h4>
              <p>
                Form Keberatan Informasi Publik yang ingin diajukan ke Politeknik Pariwisata Palembang.
              </p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="">Form Inbox Mahasiswa</a></h4>
              <p>Form untuk pengajuan pertanyaan atau keluhan dari mahasiswa Politeknik Pariwisata Palembang.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            ...
            <a href="https://poltekpar-palembang.ac.id" class="btn-learn-more">Web Poltekpar Palembang</a>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <strong>MISI</strong>
            <ul>
              <li><i class="ri-check-double-line"></i>Menyelenggarakan pendidikan, penelitian dan pengabdian masyarakat dalam bidang kepariwisataan yang berdaya saing internasional</li>
              <li><i class="ri-check-double-line"></i>Berperan aktif dalam pembangunan kepariwisataan daerah dan nasional melalui kegiatan dengan para pemangku kepentingan baik di tingkat lokal, nasional maupun internasional</li>
              <li><i class="ri-check-double-line"></i>menyelenggarakan tata kelola birokrasi secara profesional melalui peningkatan kapasitas, etos kerja dan penghargaan bagi Civitas Akademika dan tenaga kependidikan</li>
            </ul>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            <p>
              Berikut ini merupakan ringkasan jumlah pengguna buku tamu Poltekpar Palembang berdasarkan kriteria pekerjaan:
            </p>
    ...
    <section id="contact" class="contact" style="justify-content: center">
      <div class="container" data-aos="fade-up" style="justify-content: center">
        <div class="section-title">
          <h2>Contact</h2>
          <p>
            Kontak Politeknik Pariwisata Palembang
          </p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Lokasi</h4>
                <p>Jalan Sapta Pesona No 10 Kec. Silabaranti Komplek Jakabaring Sport City</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>info@poltekpar-palembang.ac.id</p>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Poltekpar Palembang</span></strong>. All Rights Reserved 2025
      </div>
    </div>
  </footer><!-- End Footer -->
